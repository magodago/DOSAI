          ...
          <div className="max-w-5xl w-full">
            ...
            <div className="bg-slate-900 border border-white/10 rounded-[3rem] overflow-hidden shadow-2xl">
              <div className="grid grid-cols-3 bg-white/5 p-8 border-b border-white/10 text-[10px] font-black uppercase tracking-[0.3em] text-slate-500">
                ...
                <div className="text-center text-cyan-500">Agente IA de David</div>
              </div>
        ...
        <section className="min-h-screen flex items-center justify-center p-6 text-center relative overflow-hidden">
          ...
          <motion.div initial={{ scale: 0.9 }} whileInView={{ scale: 1 }} className="max-w-4xl relative z-10">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="relative">
              ...
              <a href={WHATSAPP_URL} target="_blank" className="group relative inline-flex items-center gap-10 bg-white text-slate-950 px-16 md:px-24 py-10 md:py-12 rounded-full font-roboto-black-italic uppercase text-3xl md:text-6xl shadow-2xl hover:bg-cyan-500 transition-all duration-700">
                HABLAR CON DAVID
